		...
		<?php include('right_header.php');?>
			...
			<div id="mid">
				<div id="postpage"> 
								...
								<h6 style="text-align: left;"><a href="index10.php">Prev Page </a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="index12.php">Next Page</a></h6>
						
						<h2 style="font-size:25px;">Home Continue..</h2><br/><br/>
				
									<!-- Start  -->
					<a href="posts/Dilwale.php"><h3>'Dilwale' has several sequences that can set huge trends: Shah Rukh Khan</h3>	</a>
					<a href="posts/Dilwale.php"><img src="posts/trendsd1.jpg" alt="Images of Dilwale Actors"></a><br/>
					<p id="post_para" style="font-size: justify; margin-right:120px;">
						Incredible contribution to Indian cinema, the trademark dimple and arms spread wide apart are just some words to describe Shah Rukh Khan...
					</p>
					<p id="ReadMore">  
						<a href="posts/Dilwale.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					<!-- Conclusion  -->
					...
					<!-- Start  -->
					<a href="posts/Akshay.php"><h3>Akshay In Robot2 trends after Akshay Kumar joins Rajinikanth in Enthiran 2.0</h3>	</a>
					<a href="posts/Akshay.php"><img src="posts/trendse1.jpg" alt="Images of Akshay in Robot 2"></a><br/>
					<p id="post_para" style="font-size: justify; margin-right:120px;">
						Bollywood star Akshay Kumar has been roped in to play the antagonist in superstar Rajinikanth’s Enthiran 2.0, which went on the floors on Wednesday...
					</p>
					<p id="ReadMore">  
						<a href="posts/Akshay.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					<!-- Conclusion  -->
					...
					<!-- Start  -->
					<a href="posts/Modi.php"><h3>PM nod must for suspending IAS officers working with Centre</h3>	</a>
					<a href="posts/Modi.php"><img src="posts/newsa1.jpg" alt="Images of Prime Minister Narendar Modi"></a><br/>
					<p id="post_para">
						The Prime Minister is in charge of Ministry of Personnel, Public Grievances and Pensions which has DoPT as one of the departments...<br/>
					</p>
					<p id="ReadMore">  
						<a href="posts/Modi.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					<!-- Conclusion  -->
				...
				<h5 style="text-align: center;">Page 10</h5>
					<h6 style="text-align: left;"><a href="index10.php">Prev Page </a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="index12.php">Next Page</a></h6>
