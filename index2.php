		...
		<?php include('right_header.php');?>
			...
			<div id="mid">
				<div id="postpage"> 
								...
								<h6 style="text-align: left;"><a href="index.php">Prev Page
								</a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="index3.php">Next Page</a></h6>

				<h2 style="font-size:25px;">Home Continue..</h2><br/><br/>
						
						<!-- Start  -->

					<a href="posts/Carrie_Fisher.php"><h3>Carrie Fisher Calls Out Shamers on Twitter: 'Please Stop Debating Whether or Not I Aged Well'</h3>	</a>
					<a href="posts/Carrie_Fisher.php"><img src="posts/beautyc1.jpg" alt="Images of Carrie Fisher"></a><br/><br/>
						<p id="post_para" style="font-size: justify; margin-right:120px;">Carrie Fisher wants people to stop talking about her appearance...</p>
						
					</p>
					<p id="ReadMore">  
						<a href="posts/Carrie_Fisher.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					...
					<a href="posts/Cameron_Dallas.php"><h3>Cameron Dallas Explains the Beauty-Related Reason Why He Fell Down</h3>	</a>
					<a href="posts/Cameron_Dallas.php"><img src="posts/beautyd1.jpg" alt="Images of Carrie Fisher"></a><br/><br/>
						<p id="post_para" style="font-size: justify; margin-right:120px;">Cameron Dallas is known for being totally honest with his fans and when he had an embarrassing moment, he just had to let everyone know. The Vine star was simply engaging in his usual skincare routine and he had a total mishap...</p>
						
					</p>
					<p id="ReadMore">  
						<a href="posts/Cameron_Dallas.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					...
					<a href="posts/Bollywood_Pin_up.php"><h3>Bollywood Pin-up Jacqueline Fernandez to Sizzle at Premier Badminton League Opening Ceremony</h3>	</a>
					<a href="posts/Bollywood_Pin_up.php"><img src="posts/beautye1.jpg" alt="Images of Jacqueline Fernandez"></a><br/><br/>
						<p id="post_para" style="font-size: justify; margin-right:120px;">Bollywood actress Jacqueline Fernandez will be seen dancing to the tunes of her famous dance numbers at the Premier Badminton League (PBL) opening ceremony, which will be followed by a performance by music composer duo Salim-Sulaiman...</p>
						
					</p>
					<p id="ReadMore">  
						<a href="posts/Bollywood_Pin_up.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					...
					<h6 style="text-align: left;"><a href="index.php">Prev Page </a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="index3.php">Next Page</a></h6>
