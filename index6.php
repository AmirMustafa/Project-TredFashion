	...
	<script type="text/javascript" src="engine1/script.js"></script>
		...
		<?php include('right_header.php');?>
			...
			<div id="mid">
				...
				<h6 style="text-align: left;"><a href="index5.php">Prev Page </a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="index7.php">Next Page</a></h6>
						
						<h2 style="font-size:25px;">Home Continue..</h2><br/><br/>


							<!-- Start  -->
					<a href="posts/Hrithik_Roshan.php"><h3>Bollywood Actor  Hrithik Roshan.</h3></a><br/>
					<a href="posts/Hrithik_Roshan.php"><img src="posts/fashionc1.jpg" alt="Images of Hrithik Roshan"></a><br/>
					<p id="post_para" style="font-size: justify; margin-right:120px;">
						Hrithik Roshan born 10 January 1974)[1] is an Indian film actor. He has established a successful career in Bollywood, has won six Filmfare Awards...
						
					</p>
					<p id="ReadMore">  
						<a href="posts/Hrithik_Roshan.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					<!-- Conclusion  -->
					...
					<!-- Start  -->
					<a href="posts/Ian_Somerhalder.php"><h3>Actor Ian Somerhalder.</h3></a><br/>
					<a href="posts/Ian_Somerhalder.php"><img src="posts/fashiond1.jpg" alt="Images of Ian Somerhalder"></a><br/>
					<p id="post_para" style="font-size: justify; margin-right:120px;">
					...
					<p id="ReadMore">  
						<a href="posts/Ian_Somerhalder.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					<!-- Conclusion  -->
					...
					<!-- Start  -->
					<a href="posts/Stephen_Adam_Amell.php"><h3>Actor Stephen Adam Amell.</h3></a><br/>
					<a href="posts/Stephen_Adam_Amell.php"><img src="posts/fashione1.jpg" alt="Images of Stephen Adam Amell"></a><br/>
					<p id="post_para" style="font-size: justify; margin-right:120px;">
					...
					<p id="ReadMore">  
						<a href="posts/Stephen_Adam_Amell.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					<!-- Conclusion  -->
