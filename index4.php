...
<a class="wsl" href="http://wowslider.com">CSS Slideshow Gallery by WOWSlider.com v2.2.3</a>
	...
	<script type="text/javascript" src="engine1/script.js"></script>
		...
		<?php include('right_header.php');?>
			...
			<div id="mid">
				<div id="postpage"> 
<h6 style="text-align: left;"><a href="index3.php">Prev Page
</a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="index5.php">Next Page</a></h6>

				<h2 style="font-size:25px;">Home Continue..</h2><br/><br/>

				
						<!-- Start  -->
					<a href="posts/Chris_Hemsworth.php"><h3>Chris Hemsworth Ponders ‘Potentially Not Acting’ But What Kind Of World Would That Be?</h3>	</a>
					<a href="posts/Chris_Hemsworth.php"><img src="posts/celebrityc1.jpg" alt="Images of Chris Hemsworth"></a><br/>
					<p id="post_para" style="font-size: justify; margin-right:120px;">
						Well, I’ll tell you what kind of world it would be – a much, much duller place if Chris Hemsworth decided to retire from the public eye. So let’s hope he’s just being humble...
						
					</p>
					<p id="ReadMore">  
						<a href="posts/Chris_Hemsworth.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					<!-- Conclusion  -->
					...
					<!-- Start  -->
					<a href="posts/sharukh.php"><h3>Shah Rukh Khan and Deepika Padukone retain No.1 position in Times Celebex</h3>	</a>
					<a href="posts/sharukh.php"><img src="posts/celebrityd1.jpg" alt="Images of Chris Hemsworth"></a><br/>
					<p id="post_para" style="font-size: justify; margin-right:120px;">
						Launched in September 2016, Times Celebex is a monthly rating index based on several measurable parameters, including the stars' Box-Office performance, their ability to stay in the news across print, TV and online, their brand ...
						
					</p>
					<p id="ReadMore">  
						<a href="posts/sharukh.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					<!-- Conclusion  -->
					...
					<!-- Start  -->
					<a href="posts/Jennifer_Lawrence.php"><h3>Jennifer Lawrence tormented by "terrible" brothers who made her think it was "an offence to be a girl"</h3>	</a>
					<a href="posts/Jennifer_Lawrence.php"><img src="posts/celebritye1.jpg" alt="Images of Jennifer Lawrence"></a><br/>
					<p id="post_para" style="font-size: justify; margin-right:120px;">
						The star dishes on her "terrible brothers" who would torment her for being a female while growing up...
						
					</p>
					<p id="ReadMore">  
						<a href="posts/Jennifer_Lawrence.php"><b>Read More..</b></a>
					</p>
					<p id="conclusionline">-
					</p>
					<!-- Conclusion  -->
					<h5 style="text-align: center;">Page 4</h5>
					<h6 style="text-align: left;"><a href="index3.php">Prev Page </a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="index5.php">Next Page</a></h6>
